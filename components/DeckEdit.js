...
import { CancelNotifications } from './Notification'
...
class DeckEdit extends Component{
    ...
    redirect = () => {
        ...
        ///////////////////////////////////////////////////////////////////////////////////// Control to cancel notification
        let counter = 0
        Object.keys(this.props.decks).map((deckTitle)=>(
            counter = counter + (this.props.decks[deckTitle].completed === false ? 1 : 0)
        ))
            console.log('---' + counter)
        if(counter === 0){
            console.log('Notifications cancelled cause of no active decks incompleted')
            CancelNotifications()
        }
        /////////////////////////////////////////////////////////////////////////////////////
